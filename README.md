...
Все ключевые оценщики в `src/policyscope/estimators.py` снабжены подробными
русскоязычными docstring с формулами и практическими комментариями по
предпосылкам/ограничениям.
